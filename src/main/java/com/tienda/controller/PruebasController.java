...
public class PruebasController {
    ...
    public String consultaPorExistencias(@RequestParam int cantidad, Model model) {
        var productos = productoService.buscarPorExistencias(cantidad);
        model.addAttribute("productos", productos);
        model.addAttribute("filtro", "existencias");
        model.addAttribute("cantidad", cantidad);
        return "/pruebas/listado2";
    }

    @PostMapping("/queryActivos")
    public String consultaPorActivos(Model model) {
        var productos = productoService.buscarProductosActivos();
        model.addAttribute("productos", productos);
