...
public interface ProductoDao extends JpaRepository<Producto, Long> {
    ...
    //Ejemplo de método utilizando Query Consultas Ampliadas
...
// 2. Buscar por existencias
    public List<Producto> findByExistenciasGreaterThanEqual(int existencias);

// 3. Buscar solo productos activos
